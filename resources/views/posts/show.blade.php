<x-user-layout>
    ...
    <div class="max-w-3xl mx-auto mt-10 bg-green-500 border-8 border-black p-8 rounded-md ">
        ...
        <p class="text-gray-700"><span class="material-icons mr-2 align-bottom">calendar_month</span>{{ $post->date }}</p>
        ...
        <form action="{{ route('posts.like', $post) }}" method="post" class="flex justify-end">
            @csrf
            <button type="submit" class="flex items-center ml-2 mt-3 text-gray-600 text-2xl font-bold scale-150 hover:scale-180">{{ $post->likes->count() }} <svg fill="#000000" height="30px" width="40px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512.001 512.001" xml:space="preserve" stroke="#000000" stroke-width="9.216018">
        ...
        <form action="{{ route('posts.unlike', $post) }}" method="post" class="flex justify-end">
            @csrf
            @method('DELETE')
            <button type="submit" class="flex items-center ml-2 mt-3 text-gray-600 text-2xl font-bold scale-150 hover:scale-180">{{ $post->likes->count() }}<svg height="30px" width="40px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 511.467 511.467" xml:space="preserve">
    ...
    <div class="flex-col space-y-4 mb-10">
        ...
        <div class="flex  rounded-md  p-4 space-x-4 mx-auto max-w-3xl bg-green-500 border-8 border-black">
            ...
            <div class="flex flex-col justify-center">
                ...
                <span class="material-icons align-bottom">access_time</span>
