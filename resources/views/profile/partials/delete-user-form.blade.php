<section class="space-y-6">
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6 bg-red-400">
            @csrf
            @method('delete')
            ...
            <div class="mt-6  flex justify-end">
                ...
                <x-danger-button class="ms-3 bg-orange-600 hover:bg-orange-700">
